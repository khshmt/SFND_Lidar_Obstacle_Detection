...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
    ...
    //Color pcd_color(255,255,255);
    //renderPointCloud(viewer, input_cloud, "scene point cloud", pcd_color);
    ...
    //the next commented lines ate for rendering the pointCloud of obstacles and road
    /* 
    Color pcd_color2(255,0,0);
    renderPointCloud(viewer, segment_cloud.first, "obstcales", pcd_color2);
    */
    ...
    for(auto cluster : cloud_clusters)
    {
        ...
        renderBox(viewer, box, cluster_id, cluster_color[cluster_id], 1.0);
